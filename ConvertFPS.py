...
# Configuration
input_dir = "convert"           # Directory containing the input dataset (videos and JSON files)
output_dir = "converted"  # Directory where the processed dataset will be written
